      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="float-right">
            ...
            <div class="dropdown dib">
              <div class="header-icon" data-toggle="dropdown">
                <span class="user-avatar">${user.emp.firstName }
                ...
                <div class="card-body">
                  <div class="user-profile">
                    <div class="row">
                      ...
                      <div class="col-lg-8">
                        <div class="user-profile-name">${user.emp.firstName }  ${user.emp.lastName }</div>
                        <div class="user-Location">
                          <i class="ti-location-pin"></i> ${user.emp.department.name }  </div>
                        <div class="user-job-title">${user.emp.title }</div>
                        <div class="ratings">
                          <h4>Ratings</h4>
